...
Build the golden conversation-eval suite from feature.md §11; keep the scheduling-engine fixture tests as a CI gate; add LangSmith tracing and basic cost/latency dashboards.
